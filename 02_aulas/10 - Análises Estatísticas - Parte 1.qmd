...
-   No R, se houver `NA`s na **coluna** que vai ser usada para calcular as descritivas, então precisamos **remover** eles.
:::
...
-   Calcular todas as variáveis descritivas para `leaf_damage` agrupado por tratamento. Lembre de remover os `NA`s se houverem.
:::
