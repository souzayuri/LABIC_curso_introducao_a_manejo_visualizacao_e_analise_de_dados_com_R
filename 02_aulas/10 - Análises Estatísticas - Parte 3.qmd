...
1.  Faça uma regressão linear usando os dados **`riqueza_lais`.csv**
    ...
    -   **Responda**: A riqueza de espécies aumenta ou diminui em funçao da cobertura vegetal?
...
1.  Faça uma regressão linear usando os dados **`exercicio_glm`.csv**
    ...
    -   **Responda**: A riqueza de espécies aumenta ou diminui em funçao da cobertura florestal e elevação?
...
1.  Faça uma regressão linear usando os dados **`exercicio_glm.csv`**
    ...
    -   **Responda**: A riqueza de espécies aumenta ou diminui em funçao da altitude e cobertura florestal?
...
![](img/starbucks-coffee.gif){fig-align="center"}
:::
